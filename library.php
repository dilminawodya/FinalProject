...
<body >
    ...
    <ul class="nav-menu">
        ...
        <li><a href="#">Playlist & Watchlist</a></li>
        <li><a href="#">Artists</a></li>
    </ul>
</div><br>

   <h3 style="text-align: center; color:white;font-family:Verdana, Geneva, Tahoma, sans-serif;">Catalogue</h3><br>      
...
<div class="btn-group" role="group" aria-label="Basic mixed styles example">
  ...
  <button type="button" class="btn btn-light">Sinhala</button>
  <button type="button" class="btn btn-light">Bollywood</button>
  <button type="button" class="btn btn-light">Tamil</button>
...
<div class="btn-group" role="group" aria-label="Basic mixed styles example">
  <button type="button" class="btn btn-light">All</button>
  <button type="button" class="btn btn-light">Romance</button>
  <button type="button" class="btn btn-light">Rap</button>
  <button type="button" class="btn btn-light">Sinhala</button>
  <button type="button" class="btn btn-light">English</button>
  <button type="button" class="btn btn-light">Tamil</button>
  <button type="button" class="btn btn-light">Hindi</button>
  <button type="button" class="btn btn-light">Classical</button>
  <button type="button" class="btn btn-light">Country</button>
  <button type="button" class="btn btn-light">Children</button>
  <button type="button" class="btn btn-light">Pop</button>
  <button type="button" class="btn btn-light">Kids</button>
</div>
 </div>   <br>

 <div class="container">
    <h4 style=color:gray>TV Series</h4>
 ...
 <div class="btn-group" role="group" aria-label="Basic mixed styles example">
  ...
  <button type="button" class="btn btn-light">Horror</button>
  <button type="button" class="btn btn-light">Tamil</button>
  <button type="button" class="btn btn-light">Reality show</button>
  <button type="button" class="btn btn-light">Family</button>
  <button type="button" class="btn btn-light">Children</button>
  <button type="button" class="btn btn-light">Country</button>
  <button type="button" class="btn btn-light">Musical</button>
</div>
 </div>   <br>
 ...
 <div class="btn-group" role="group" aria-label="Basic mixed styles example">
  ...
  <button type="button" class="btn btn-light">English</button>
  <button type="button" class="btn btn-light">Bollywood</button>
  <button type="button" class="btn btn-light">Hollywood</button>
  <button type="button" class="btn btn-light">Sihala</button>
  <button type="button" class="btn btn-light">Korean</button>
  <button type="button" class="btn btn-light">Chines</button>
  <button type="button" class="btn btn-light">Tamil</button>
  <button type="button" class="btn btn-light">Thailand</button>
