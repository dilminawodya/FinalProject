...
<head>
    ...
    <link rel="stylesheet" href="Playlist-watchlist.css">
    <style>
        body {
...
<body >
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js"></script>
   ...
   <h3 style="text-align: center; color:white;font-family:Verdana, Geneva, Tahoma, sans-serif;"><u>Playlist & Watchlist</u></h3><br> 
